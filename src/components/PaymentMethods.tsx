        ...
        <div className="relative">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <div className="text-lg font-bold text-zinc-900 dark:text-white">Asmat Ullah</div>
            </div>
          ...
          <div>
            ...
            <div className="flex items-center justify-between bg-white dark:bg-black/40 p-3 rounded-xl border border-zinc-200 dark:border-zinc-800/50">
              <div className="font-mono text-xl font-bold tracking-wider text-emerald-600 dark:text-emerald-500">03416286423</div>
              <button 
                onClick={onCopy}
