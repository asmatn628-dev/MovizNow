        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-12">
            <section className="mt-8">
              {imdbData && imdbData.rating && imdbData.posterUrl && imdbData.posterUrl.trim() !== "" && imdbData.posterUrl !== content.posterUrl ? (
                <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row gap-8 relative overflow-hidden">
                  ...
                  {imdbData.posterUrl && imdbData.posterUrl.trim() !== "" && imdbData.posterUrl !== content.posterUrl && (
                  ...
                  <div className="flex-1 space-y-4">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex flex-col items-end gap-2">
                        {imdbData.rating && (
                          <div className="bg-[#f5c518] text-black px-3 py-1 rounded-lg font-bold flex items-center gap-1.5 shadow-[0_0_15px_rgba(245,197,24,0.3)]">
                            <svg viewBox="0 0 48 48" className="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg">
                              <path d="M44 13H4c-2.2 0-4 1.8-4 4v14c0 2.2 1.8 4 4 4h40c2.2 0 4-1.8 4-4V17c0-2.2-1.8-4-4-4z" fill="#f5c518"/><path d="M28.1 27.3l.7-4.1 1.1 4.1h1.9l1.1-4.1.7 4.1h2.1l-1.4-7.1h-2.4l-1 3.8-1-3.8h-2.4l-1.4 7.1h2zm-15.1 0h2V20.2h-2v7.1zm4.4 0h2V20.2h-2v7.1zm11.9-7.1h-2.1l-1.4 7.1h2.1l1.4-7.1zm-19.3 0h-2.4l-1.4 7.1h2.4l1.4-7.1zm28.2 0h-2.4l-1.4 7.1h2.4l1.4-7.1z" fill="#000"/>
                            </svg>
                            <span className="text-sm">{imdbData.rating}</span>
                          </div>
                        )}
                      </div>
                    </div>
