    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center text-white p-4">
      <div className="max-w-md w-full bg-zinc-900 rounded-2xl p-8 shadow-2xl border border-zinc-800 text-center">
        <div className="flex justify-center mb-6">
          <img src="/logo.svg?v=2" alt="MovizNow Logo" className="w-24 h-24" />
        </div>
        ...
        <button
          ...
          className="w-full bg-white text-zinc-900 font-semibold py-3 px-4 rounded-xl hover:bg-zinc-200 transition-colors flex items-center justify-center gap-3"
        >
